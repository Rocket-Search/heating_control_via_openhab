//clear; rm -frv read_dht22.o; g++ -g -fPIC -Wall -c read_dht22.cpp
...
int gpio_port = 24;
unsigned short humidity_and_temper[5] = {0, 0, 0, 0, 0};	
extern float humidity;
extern bool dht22_falsche_werte;

void extern read_dht22()
{
	...
	for (int i = 0; i < 10; i++)
	{
		...
		pinMode(gpio_port, INPUT);		// 'INPUT' equals 'HIGH' level. And signal read mode
		...
		while (1)
		{
			...
			while (digitalRead(gpio_port) == HIGH)
			{
				signal_laenge++;
